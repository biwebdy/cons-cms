...
module.exports = (config, { strapi }) => {
  ...
  return async (ctx, next) => {
    // console.log("In user-can-update middleware.");
    ...
    //   const message = `You are not authorized to update user with ID ${requestedUserId}.`;
    //   strapi.log.error(message);
    //   console.log("You are not authorized to update user with ID", requestedUserId);
